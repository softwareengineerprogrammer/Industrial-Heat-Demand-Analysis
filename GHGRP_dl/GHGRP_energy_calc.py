...
def format_GHGRP_facilities(fac_file_2010, oth_facfiles):
    ...
    MECS_regions = pd.read_csv('US_FIPS_Codes.csv', index_col=['COUNTY_FIPS'])
...
def id_industry_groups(GHGs):
    ...
    grouping_dict = {
        'Agriculture': [111, 115],
        'Mining and Extraction': [211, 212, 213],
        'Utilities': 221,
        ...
        'Publishing': [511, 512, 515, 517, 518, 519],
        'Finance and Insurance': [521, 522, 523, 524, 525],
        'Real Estate and Leasing': [531, 532, 533],
        'Professional, Scientific, and Technical Services': 541,
        'Management of Companies': 551,
        'Admini and Support and Waste Management and Remediation Services': [561, 562],
        ...
        'Other Services': [811, 812, 813, 814],
        'Public Adminsitration': [921, 922, 923, 924, 925, 926, 927, 928]
    }
